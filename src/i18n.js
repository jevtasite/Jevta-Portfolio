...
const resources = {
  en: {
    translation: {
      ...
      'about.birthDay': 'January 15, 2000',
      'about.job': 'Job',
      ...
      'about.bio1':
        "Hello! I'm Luka Stoiljković, also known as Jevta. I'm a passionate front-end developer who loves creating beautiful and functional web experiences.",
      'about.bio2':
      ...
      'experience.status': 'Currently open to new opportunities and exciting projects!',
  ...
  sr: {
    translation: {
      ...
      'about.bio1':
        'Zdravo! Ja sam Luka Stoiljković, poznat i kao Jevta. Strastveni sam front-end developer koji voli da kreira lepa i funkcionalna veb iskustva.',
      'about.bio2':
        'Specijalizovan sam za moderne veb tehnologije i imam dobro oko za dizajn. Moj cilj je da gradim veb sajtove koji ne samo da izgledaju odlično, već i pružaju izvrsno korisničko iskustvo.',
      'about.bio3':
        'Kada ne kodiram, možete me naći kako istražujem nove tehnologije, doprinosim open source projektima ili delim svoje znanje sa zajednicom programera.',
      ...
      'skills.htmlCss': 'HTML/CSS',
      'skills.htmlCssDesc':
        'Stručnjak u semantičkom HTML5 i modernom CSS3, uključujući Flexbox, Grid, animacije i principe responsive dizajna.',
      'skills.javascript': 'JavaScript/ES6+',
      'skills.javascriptDesc':
      ...
      'skills.tailwind': 'Tailwind CSS',
      'skills.tailwindDesc':
        'Brzi razvoj UI-a sa utility-first CSS framework-om, prilagođenim konfiguracijama i responsive dizajn šablonima.',
      'skills.git': 'Git & Version Control',
      'skills.gitDesc':
        'Iskustvo sa Git workflow-ima, strategijama grananja, kolaborativnim razvojem i GitHub/GitLab platformama.',
      'skills.responsive': 'Responsive dizajn',
      'skills.responsiveDesc':
      ...
      'experience.freelanceDesc':
        'Radim samostalno na različitim projektima veb razvoja za klijente. Specijalizujem se za kreiranje modernih, responsive veb sajtova sa čistim kodom i izvrsnim korisničkim iskustvom. Upravljam svim aspektima projekata od komunikacije sa klijentima do implementacije.',
      'experience.technologies': 'Korišćene tehnologije',
      'experience.certificate': 'Pogledaj sertifikat',
      'experience.status': 'Trenutno otvoren za nove prilike i uzbudljive projekte!',

      // Portfolio Section
      'portfolio.title': 'Portfolio projekti',
      'portfolio.fieldFocus':
        'Profesionalni veb sajt za kompaniju koja se bavi poljoprivrednom tehnologijom, sa modernim dizajnom, responsive rasporedom i optimizovanim performansama za prikazivanje njihovih inovativnih rešenja.',
      'portfolio.platinumMedia':
        'Portfolio veb sajt kreativne agencije sa dinamičkim sadržajem, glatkim animacijama i privlačnim korisničkim interfejsom dizajniranim da istakne njihov kreativan rad i usluge.',
      'portfolio.playmaker':
      ...
      'portfolio.lequipe':
        'Elegantan veb sajt za kompaniju za menadžment talenata sa sofisticiranim dizajnom, glatkim prelazima i intuitivnom navigacijom za prikazivanje njihovog roster-a i usluga.',
      ...
      'services.webDev': 'Veb razvoj',
      'services.webDevDesc':
        'Gradnja modernih, responsive veb sajtova sa čistim kodom i najboljim praksama. Od landing stranica do kompleksnih veb aplikacija, kreiram rešenja koja su brza, pristupačna i održiva.',
      ...
      'services.consultancyDesc':
        'Pružanje stručnih saveta o projektima veb razvoja, tehničkim odlukama i digitalnoj strategiji. Pomažem vam da odaberete prave tehnologije i pristupe za vaše specifične potrebe.',
      'services.features': 'Karakteristike',
      'services.workTogether': 'Hajde da sarađujemo',
      'services.workTogetherDesc':
        'Imate projekat na umu? Dostupan sam za freelance rad i saradnje. Hajde da kreiramo nešto neverovatno zajedno!',
      ...
      'contact.email': 'Email',
      'contact.emailDesc':
        'Pošalji mi email i javiću ti se što pre!',
      ...
      // Footer
      'footer.tagline':
        'Front-end Developer koji kreira moderna veb iskustva sa čistim kodom i kreativnim dizajnom.',
